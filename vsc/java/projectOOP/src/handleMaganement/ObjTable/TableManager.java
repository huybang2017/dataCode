    ...
    public void updateTable(String tableCode) {
        ...
        switch (choice) {
            ...
            case 4:
                ...
                break;
            case 5:
                System.out.print("Nhập trạng thái bàn (true/fasle): ");
    ...
    public void writeTablesToFile(String filePath) {
        ...
        for (Table table : tables) {
            tableData.add("Mã bàn: " + table.getTableCode() + ";Số bàn: " + table.getTableNumber() +
                    ";Số ghế: " + table.getNumberOfSeats() + ";Tên bàn: " + table.getTableName() + ";Trạng thái bàn: "
                    + (table.isStatusTable() ? "Đã đặt" : "Bàn trống"));
