...
import handleMaganement.ObjOrder.OrderAction;
...
public class CoffeeShopManagement {
    public void CoffeeMenu() {
        ...
        do {
            System.out.println("+---------------------------------------------+");
            System.out.println("|        Quản lý của hàng coffee              |");
            System.out.println("| -------------------=====--------------------|");
            System.out.println("| 1. Quản lý bàn                              |");
            System.out.println("| 2. Thực hiện mua hàng                       |");
            ...
            switch (choice) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    ListCustomer listCustomer1 = new ListCustomer();
                    listCustomer1.readListCustomer();
                    listCustomer1.registerMember();
                    break;
                case 9:
