...
public class SanPham {
    ...
    public String getCoDaAsString() {
        return coDa ? "Có" : "Không";
    }

    public String getAddonsAsString() {
        return addons != null ? Arrays.toString(addons) : "Không có addons";
    }

    @Override
    public String toString() {
        return "Masp: " + maSanPham + ", Món: " + tenSanPham + ", Loại: " + loai + ", Giá: " + gia +
                " VND, Ghi chú: " + ghiChu + ", Size: " + size + ", Đá: " + getCoDaAsString() +
                ", Addons: " + getAddonsAsString();
    }
}
